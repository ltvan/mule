...
@ArtifactClassLoaderRunnerConfig(pluginCoordinates = "org.mule.modules:mule-module-dbn",
    exportPluginClasses = {DbConnectionProvider.class, DerbyTestStoredProcedure.class})
