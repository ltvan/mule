...
public class DependencyResolver {
  ...
  public ArtifactDescriptorResult readArtifactDescriptor(Artifact artifact) {
    ...
    try {
      ...
      throw new RuntimeException("Couldn't read descriptor for artifact: '" + artifact
          + "'", e);
    }
  }
  ...
  public ArtifactResult resolveArtifact(Artifact artifact) {
    ...
    try {
      ...
      throw new RuntimeException("Couldn't resolve artifact: '" + artifact
          + "'", e);
    }
  }
  ...
  public List<File> resolveDependencies(Dependency root, List<Dependency> directDependencies,
    ...
    try {
      ...
      throw new RuntimeException("Dependencies couldn't be resolved. See logs to understand which dependencies are missed " +
          "in the dependency graph", e);
    }
